  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      particles.forEach((p) => {
        ...
        // Move particle upwards & drift slightly horizontally
        p.y -= p.speedY;
        p.x += p.speedX;

        // Soft breathing opacity effect
      ...
      // Clear shadow properties so they don't affect other draws
      ctx.shadowBlur = 0;
